...
object ApiFormats {
   ...
   */
  val FormatKey: String = "skinny.micro.FormatKey"
 ...
 */
trait ApiFormats extends SkinnyMicroBase with RicherStringImplicits {
  ...
  def responseFormat(implicit ctx: SkinnyMicroContext): String = {
    format(ctx)
  }
  ...
  private[this] def getFromParams(implicit ctx: SkinnyMicroContext): Option[String] = {
  ...
  private def getFormat(implicit ctx: SkinnyMicroContext): String = {
  ...
  def requestFormat(implicit ctx: SkinnyMicroContext): String = {
   ...
   * $ - the default format
   */
  def format(implicit ctx: SkinnyMicroContext): String = {
