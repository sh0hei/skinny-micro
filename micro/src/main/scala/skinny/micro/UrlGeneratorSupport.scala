...
trait UrlGeneratorSupport {
   ...
   */
  def url(route: Route, params: Tuple2[String, String]*)(implicit ctx: SkinnyMicroContext): String =
   ...
   * determined.  This may occur outside of an HTTP request's lifecycle.
   */
  def url(route: Route, splat: String, moreSplats: String*)(implicit ctx: SkinnyMicroContext): String =
  ...
  def url(
    ...
    splats: Iterable[String])(implicit ctx: SkinnyMicroContext): String = {
