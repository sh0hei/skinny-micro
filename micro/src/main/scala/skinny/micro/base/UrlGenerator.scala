...
trait UrlGenerator extends RicherStringImplicits { self: SkinnyMicroBase =>
  ...
  private[this] def appendSessionIdToUri(uri: String)(implicit ctx: SkinnyMicroContext): String = {
  ...
  def relativeUrl(
    ...
    includeServletPath: Boolean = true)(implicit ctx: SkinnyMicroContext): String = {
  ...
  def url(
    ...
    withSessionId: Boolean = true)(implicit ctx: SkinnyMicroContext): String = {
    try {
  ...
  private[this] def buildBaseUrl(implicit ctx: SkinnyMicroContext): String = {
    "%s://%s".format(
  ...
  private[this] def ensureContextPathsStripped(path: String)(implicit ctx: SkinnyMicroContext): String = {
    ((ensureContextPathStripped _) andThen (p => ensureServletPathStripped(p)(ctx)))(path)
  }

  private[this] def ensureServletPathStripped(path: String)(implicit ctx: SkinnyMicroContext): String = {
