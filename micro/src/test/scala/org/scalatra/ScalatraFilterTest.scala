...
class ScalatraFilterTestFilter extends SkinnyMicroFilter {
...
class ScalatraFilterTestPathMappedServlet extends SkinnyMicroServlet {
  get("/filtered") {
    "path-mapped"
  }
...
class ScalatraFilterTestExtensionMappedServlet extends SkinnyMicroServlet {
  get("/filtered.do") {
    "extension-mapped"
  }
  ...
  override def requestPath(implicit ctx: SkinnyMicroContext) = ctx.request.getServletPath
}

class ScalatraFilterTestDefaultServlet extends SkinnyMicroServlet {
  get("/filtered") {
    "default"
  }
...
class ScalatraFilterTestExactMatchServlet extends SkinnyMicroServlet {
  get("/exact-match/filtered") {
    "exact match"
  }
